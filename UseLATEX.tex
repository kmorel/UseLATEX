...
\newcommand{\UseLATEXVersion}{1.7.2}
...
convert.exe: unable to open image `C:': Permission denied.
  ...
  \subsection{How do automate plot generation with command line programs?}
  \label{How_do_automate_plot_generation_with_command_line_programs}
